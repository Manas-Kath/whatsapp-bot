...
const Hardware = {
    toggle: async (id, state) => {
        try {
            ...
            // Using an empty string "" instead of {} to ensure Content-Length is set correctly
            ...
            // Fallback attempt with explicit Content-Length
            try {
                ...
                throw new Error(`Command failed. Check if the device is at ${DEVICE_IP}`);
            }
        }
    },
